  ...
  (function(global, factory) {
    ...
    var OfflineCompiler = (function() {
      ...
      OfflineCompiler.prototype.compileModules = function(staticSymbols, options) {
        var _this = this;
        return analyzeNgModules(staticSymbols, options, this._metadataResolver).then(function(_a) {
          var ngModuleByPipeOrDirective = _a.ngModuleByPipeOrDirective,
              files = _a.files;
    ...
    function _loadNgModules(programStaticSymbols, options, metadataResolver) {
      ...
      var addNgModule = function(staticSymbol) {
        ...
        var _a = metadataResolver.loadNgModuleMetadata(staticSymbol, false, false),
      ...
      return Promise.all(loadingPromises).then(function() {
        return Array.from(ngModules.values());
      });
    }
    ...
    var CompileMetadataResolver = (function() {
      ...
      CompileMetadataResolver.prototype._getTransitiveNgModuleMetadata = function(importedModules, exportedModules) {
        ...
        var loadingPromises = ListWrapper.flatten(transitiveExportedModules.map(function(ngModule) {
          return ngModule.loadingPromises;
        }));
