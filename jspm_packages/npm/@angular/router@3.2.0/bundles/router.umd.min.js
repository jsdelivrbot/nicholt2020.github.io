...
(function(process) {
  !function(global, factory) {
    ...
    function validateNode(route) {
      ...
      if (void 0 === route.component && route.outlet && route.outlet !== PRIMARY_OUTLET)
    ...
    function inheritedParamsDataResolve(route) {
      for (var pathToRoot = route.pathFromRoot,
        ...
        var current = pathToRoot[inhertingStartingFrom],
            parent_1 = pathToRoot[inhertingStartingFrom - 1];
      ...
      return pathToRoot.slice(inhertingStartingFrom).reduce(function(res, curr) {
        var params = merge(res.params, curr.params),
            data = merge(res.data, curr.data),
            resolve = merge(res.resolve, curr._resolvedData);
        return {
          params: params,
          data: data,
          resolve: resolve
    ...
    function advanceActivatedRoute(route) {
      route.snapshot ? (shallowEqual(route.snapshot.queryParams, route._futureSnapshot.queryParams) || route.queryParams.next(route._futureSnapshot.queryParams), route.snapshot.fragment !== route._futureSnapshot.fragment && route.fragment.next(route._futureSnapshot.fragment), shallowEqual(route.snapshot.params, route._futureSnapshot.params) || route.params.next(route._futureSnapshot.params), shallowEqualArrays(route.snapshot.url, route._futureSnapshot.url) || route.url.next(route._futureSnapshot.url), equalParamsAndUrlSegments(route.snapshot, route._futureSnapshot) || route.data.next(route._futureSnapshot.data), route.snapshot = route._futureSnapshot) : (route.snapshot = route._futureSnapshot, route.data.next(route._futureSnapshot.data));
    }
    ...
    function setupRouter(ref, urlSerializer, outletMap, location, injector, loader, compiler, config, opts, urlHandlingStrategy) {
      ...
      if (urlHandlingStrategy && (router.urlHandlingStrategy = urlHandlingStrategy), opts.errorHandler && (router.errorHandler = opts.errorHandler), opts.enableTracing) {
        var dom_1 = getDOM();
    ...
    function initialRouterNavigation(router, ref, preloader, opts) {
      return function(bootstrappedComponentRef) {
        bootstrappedComponentRef === ref.components[0] && (router.resetRootComponentType(ref.componentTypes[0]), preloader.setUpPreloading(), opts.initialNavigation === !1 ? router.setUpLocationChangeListener() : router.initialNavigation());
      };
    }
      ...
      d.prototype = null === b ? Object.create(b) : (__.prototype = b.prototype, new __);
        ...
        LoadedRouterConfig = function() {
          function LoadedRouterConfig(routes, injector, factoryResolver, injectorFactory) {
            this.routes = routes, this.injector = injector, this.factoryResolver = factoryResolver, this.injectorFactory = injectorFactory;
          }
          ...
          return RouterConfigLoader.prototype.load = function(parentInjector, loadChildren) {
            return rxjs_operator_map.map.call(this.loadModuleFactory(loadChildren), function(r) {
              var ref = r.create(parentInjector),
                  injectorFactory = function(parent) {
        ...
        ApplyRedirects = function() {
          ...
          return ApplyRedirects.prototype.apply = function() {
            ...
            var _this = this;
            return route.children ? rxjs_observable_of.of(new LoadedRouterConfig(route.children, injector, null, null)) : route.loadChildren ? rxjs_operator_mergeMap.mergeMap.call(runGuards(injector, route), function(shouldLoad) {
            ...
            }) : rxjs_observable_of.of(new LoadedRouterConfig([], injector, null, null));
          }, ApplyRedirects;
        }(),
        Tree = function() {
          function Tree(root) {
        ...
        Recognizer = function() {
          ...
          return Recognizer.prototype.recognize = function() {
            ...
            return 0 === segmentGroup.segments.length && segmentGroup.hasChildren() ? this.processChildren(config, segmentGroup) : this.processSegment(config, segmentGroup, 0, segmentGroup.segments, outlet);
        ...
        Router = function() {
          ...
          return Router.prototype.resetRootComponentType = function(rootComponentType) {
            ...
            return void 0 === extras && (extras = {skipLocationChange: !1}), "object" == typeof extras.queryParams && null !== extras.queryParams && (extras.queryParams = this.removeEmptyProps(extras.queryParams)), this.navigateByUrl(this.createUrlTree(commands, extras), extras);
            ...
            var _this = this,
                ...
                prevUrl = prevRawUrl ? this.urlHandlingStrategy.extract(prevRawUrl) : null,
                urlTransition = !prevUrl || url.toString() !== prevUrl.toString();
            ...
            }).then(resolve, reject)) : urlTransition && prevRawUrl && this.urlHandlingStrategy.shouldProcessUrl(prevRawUrl) ? (this.routerEvents.next(new NavigationStart(id, this.serializeUrl(url))), Promise.resolve().then(function(_) {
              return _this.runNavigate(url, rawUrl, !1, !1, id, createEmptyState(url, _this.rootComponentType));
            ...
            return id !== this.navigationId ? (this.location.go(this.urlSerializer.serialize(this.currentUrlTree)), this.routerEvents.next(new NavigationCancel(id, this.serializeUrl(url), "Navigation ID " + id + " is not equal to the current navigation id " + this.navigationId)), Promise.resolve(!1)) : new Promise(function(resolvePromise, rejectPromise) {
              ...
              if (precreatedState)
                appliedUrl = url, routerState$ = rxjs_observable_of.of(precreatedState);
              else {
              ...
              var preactivation$ = rxjs_operator_map.map.call(routerState$, function(newState) {
                state = newState, preActivation = new PreActivation(state.snapshot, _this.currentRouterState.snapshot, _this.injector), preActivation.traverse(_this.outletMap);
                  ...
                  preactivation2$ = rxjs_operator_mergeMap.mergeMap.call(preactivation$, function() {
                    return _this.navigationId !== id ? rxjs_observable_of.of(!1) : preActivation.checkGuards();
                  }),
                  resolveData$ = rxjs_operator_mergeMap.mergeMap.call(preactivation2$, function(shouldActivate) {
                    return _this.navigationId !== id ? rxjs_observable_of.of(!1) : shouldActivate ? rxjs_operator_map.map.call(preActivation.resolveData(), function() {
              ...
              resolveData$.forEach(function(shouldActivate) {
                ...
                _this.navigated = !0, navigationIsSuccessful ? (_this.routerEvents.next(new NavigationEnd(id, _this.serializeUrl(url), _this.serializeUrl(appliedUrl))), resolvePromise(!0)) : (_this.resetUrlToCurrentUrlTree(), _this.routerEvents.next(new NavigationCancel(id, _this.serializeUrl(url), "")), resolvePromise(!1));
              }, function(e) {
        ...
        PreActivation = function() {
          ...
          return PreActivation.prototype.traverse = function(parentOutletMap) {
            ...
            var checks$ = rxjs_observable_from.from(this.checks),
                runningChecks$ = rxjs_operator_mergeMap.mergeMap.call(checks$, function(s) {
            ...
            }), r.component && outlet && outlet.isActivated ? this.checks.push(new CanDeactivate(outlet.component, r)) : this.checks.push(new CanDeactivate(null, r));
            ...
            var canDeactivate$ = rxjs_operator_mergeMap.mergeMap.call(rxjs_observable_from.from(canDeactivate), function(c) {
              ...
              return observable = wrapIntoObservable(guard.canDeactivate ? guard.canDeactivate(component, curr, _this.curr) : guard(component, curr, _this.curr)), rxjs_operator_first.first.call(observable);
            });
            ...
            return rxjs_operator_map.map.call(this.resolveNode(resolve, future), function(resolvedData) {
              return future._resolvedData = resolvedData, future.data = merge(future.data, inheritedParamsDataResolve(future).resolve), null;
            });
          ...
          return ActivateRoutes.prototype.activate = function(parentOutletMap) {
            ...
            var resolved = [{
              ...
              useValue: outletMap
                ...
                resolver = null,
                injector = null;
            config ? (injector = config.injectorFactory(outlet.locationInjector), resolver = config.factoryResolver, resolved.push({
              provide: _angular_core.ComponentFactoryResolver,
              useValue: resolver
            })) : (injector = outlet.locationInjector, resolver = outlet.locationFactoryResolver), outlet.activate(future, resolver, injector, _angular_core.ReflectiveInjector.resolve(resolved), outletMap);
        ...
        RouterLink = function() {
          ...
          return Object.defineProperty(RouterLink.prototype, "routerLink", {
            ...
            return this.router.navigateByUrl(this.urlTree), !0;
          ...
          return Object.defineProperty(RouterLinkActive.prototype, "isActive", {
            ...
            if (this.links && this.linksWithHrefs && this.router.navigated) {
              ...
              this.classes.forEach(function(c) {
                c && _this.renderer.setElementClass(_this.element.nativeElement, c, isActive);
              });
            }
        ...
        getDOM = _angular_platformBrowser.__platform_browser_private__.getDOM,
        ...
        ROUTER_INITIALIZER = new _angular_core.OpaqueToken("Router Initializer"),
        __router_private__ = {
