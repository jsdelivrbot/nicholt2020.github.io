...
!function(global, factory) {
  ...
  function initialRouterNavigation(ngUpgrade, ref, preloader, opts) {
    return function() {
      var router = ngUpgrade.injector.get(_angular_router.Router),
          ref = ngUpgrade.injector.get(_angular_core.ApplicationRef);
      router.resetRootComponentType(ref.componentTypes[0]), preloader.setUpPreloading(), opts.initialNavigation === !1 ? router.setUpLocationChangeListener() : setTimeout(function() {
        router.initialNavigation();
      }, 0), ngUpgrade.$injector.get("$rootScope").$on("$locationChangeStart", function(_, next, __) {
  ...
  exports.RouterUpgradeInitializer = RouterUpgradeInitializer, exports.initialRouterNavigation = initialRouterNavigation;
});
